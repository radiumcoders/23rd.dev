...
<CliCommand command="shadcn@latest add @23rd/ascii-logo" />

Or install straight from the public GitHub source registry:

<CliCommand
  npm="npx shadcn@latest add radiumcoders/23rd.dev/ascii-logo"
  pnpm="pnpm dlx shadcn@latest add radiumcoders/23rd.dev/ascii-logo"
  yarn="yarn dlx shadcn@latest add radiumcoders/23rd.dev/ascii-logo"
  bun="bunx --bun shadcn@latest add radiumcoders/23rd.dev/ascii-logo"
/>
